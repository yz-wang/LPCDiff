...
gt_path = '/opt/data/private/SJ/LPCDiff/test_data/O_HAZE/gt'
results_path = '/opt/data/private/SJ/LPCDiff_1/results/O_HAZE/val_iter5000'

imgsName = sorted(os.listdir(results_path))
gtsName = sorted(os.listdir(gt_path))

# assert len(imgsName) == len(gtsName) * 10
